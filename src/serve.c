...
static const char* mime_from_ext(const char* path){
  ...
  if (strequal_ci(ext,"js") || strequal_ci(ext,"mjs"))    return "application/javascript; charset=utf-8";
  ...
  if (strequal_ci(ext,"ttf"))   return "font/ttf";
  if (strequal_ci(ext,"otf"))   return "font/otf";

  if (strequal_ci(ext,"map"))   return "application/json; charset=utf-8";
